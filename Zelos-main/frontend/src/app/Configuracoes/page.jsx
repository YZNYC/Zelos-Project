...
export default function Configuracoes() {
  ...
  const [user, setUser] = useState({ nome: "", id: "" });
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-8 transition-colors duration-300 mt-[-70px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <input
            ...
            readOnly
          />
          <label className="block mb-2 text-gray-700 dark:text-gray-200">Id:</label>
          <input
            type="email"
            value={user.id}
            className="w-full p-2 mb-4 rounded bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100"
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow w-182">
          <h2 className="text-4xl font-semibold mb-8 text-gray-800 dark:text-gray-100">
            Notificações
          </h2>

          {["Novos chamados", "Respostas ao chamados", "Chamados encerrados"].map((notif, i) => (
            <div key={i} className="flex items-center justify-between mb-3">
              <span className="text-gray-700 dark:text-gray-200 text-xl">{notif}</span>
